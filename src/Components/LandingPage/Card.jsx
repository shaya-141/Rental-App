  ...
  return (
    <div className='w-[330px] h-[440px] mt-10  rounded-2xl '>
        <div className='h-[75%] w-full'>
            <img src={cardimg} className='h-full rounded-2xl w-full' alt="" />
        </div>
        <p className='flex items-center mt-4 font-medium gap-1'><img src={locate} className='h-4' alt="" />Majeed Colony</p>
        <div className='flex items-center justify-between mt-1'>
            <h1 className='text-[20px] font-semibold'>SunnyVale Retreat</h1>
            <h1 className='text-[20px] font-semibold'>500$</h1>
        </div>
        <div className='flex items-center mt-2 gap-2  font-medium '>
            ...
            <p className='flex items-center gap-1 text-[14px] text-[#656e73] font-semibold'>|<img src={area} className='h-4' alt="" />80 </p>
        </div>
